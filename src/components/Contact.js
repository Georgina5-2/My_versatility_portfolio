    ...
    const emptyFieldCheck=()=>{
        ...
        return(
            <div className="post-body">
                <h2 className='font-os font-red d-flex justify-content-center m-4'>Contact Me</h2>
                <form className='d-flex-col justify-content-center'>
                    ...
                    <div className="d-flex-col justify-content-center p-1">
                        ...
                        {messageErr ? <p className="d-flex justify-content-center p-1 font-os font-white">Please enter a short message (Minimum 10 characters required)(required)</p>:null}
