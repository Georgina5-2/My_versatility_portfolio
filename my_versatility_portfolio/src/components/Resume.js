...
const Resume = () => {
    return (
        <div className="post-body d-flex-col">
            <h4 className="d-flex justify-content-center p-3 font-os font-pink font-large">View my resume <a href="" target="_blank" rel="noreferrer" className="text-decoration-none" >&nbsp;here</a></h4>
